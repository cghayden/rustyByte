...
import TerminalToggleEdit from '@/components/TerminalToggleEdit';
    ...
    <div className="bg-stone-800 text-gray-300 py-4 px-3 pb-16">
      <div className="max-w-2xl mx-auto">
        <div className="mb-4 flex items-start justify-between">
          <div>
            <h1 className="text-2xl font-bold">Edit Challenge: {challengeData.title}</h1>
        ...
        <form action={updateChallenge} className="space-y-4">
          ...
          <div className="bg-yellow-100 shadow-md rounded-lg p-2 space-y-4">
            ...
            {/* Terminal Option */}
            <TerminalToggleEdit
              dockerImages={availableDockerImages}
              currentDockerImage={challengeData.dockerImage}
            />
          ...
          <div className="bg-yellow-100 shadow-md rounded-lg p-1 mt-4">
            ...
            <p className="text-gray-600 mb-3 text-sm">
              Upload files for participants to download; 50 MB max
            </p>
            <FileUpload
